...
# --run_name half-metamath-qwen2.5-stage1
# --seed 42
...
# --run_name half-metamath-qwen2.5-stage2
# --seed 42
# --output_exists True
# --enc_name_or_path Qwen/Qwen2.5-1.5B-Instruct
# --lm_name_or_path meta-math/MetaMath-7B-V1.0
...
--n_gpu $NUM_GPUS
--strategy deepspeed_stage_2
--output_dir checkpoints/metamath-qwen2.5-stage3-test
--run_name half-metamath-qwen2.5-stage3
--seed 42
--output_exists True
--enc_name_or_path Qwen/Qwen2.5-1.5B-Instruct
--lm_name_or_path meta-math/MetaMath-7B-V1.0
