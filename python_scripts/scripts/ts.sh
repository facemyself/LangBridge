...
LOG_NAME="Multilingual/MetaMath-qwen2.5/MetaMath-qwen2.5-stage1-10k"
...
ts -G 4 -L $LOG_NAME -O MetaMath-qwen2.5-stage1-10k.log bash scripts/train_lb/metamath.sh